...
Dry run passed.
Running recipes/pipeline_101/config.toml
  inputs loaded: 1 variable(s) from 1 source(s)
  DAG built: executing 2 output node(s)
  ✓ wrote recipes/pipeline_101/results/anomaly.nc (2 variable(s), 13.1 kB)
Run completed in 0.02s
</pre>
...
Attributes:
    ...
    conduit_config_sha256:  398cf5d57f2fcd06bda47eb89779f0a34b13318238b742adb...</pre><div class='xr-wrap' style='display:none'><div class='xr-header'><div class='xr-obj-type'>xarray.Dataset</div></div><ul class='xr-sections'><li class='xr-section-item'><input id='section-d5caf201-0194-4df0-981f-f3f9f0e8c370' class='xr-section-summary-in' type='checkbox' disabled /><label for='section-d5caf201-0194-4df0-981f-f3f9f0e8c370' class='xr-section-summary'>Dimensions:</label><div class='xr-section-inline-details'><ul class='xr-dim-list'><li><span class='xr-has-index'>time</span>: 90</li><li><span class='xr-has-index'>site</span>: 3</li></ul></div></li><li class='xr-section-item'><input id='section-6216e7e0-98ef-47ad-878c-c3268f9b771a' class='xr-section-summary-in' type='checkbox' checked /><label for='section-6216e7e0-98ef-47ad-878c-c3268f9b771a' class='xr-section-summary' title='Expand/collapse section'>Coordinates: <span>(2)</span></label><div class='xr-section-inline-details'></div><div class='xr-section-details'><ul class='xr-var-list'><li class='xr-var-item'><div class='xr-var-name'><span class='xr-has-index'>time</span></div><div class='xr-var-dims'>(time)</div><div class='xr-var-dtype'>datetime64&#91;ns&#93;</div><div class='xr-var-preview xr-preview'>2020-01-01 ... 2020-03-30</div><input id='attrs-f9fbf26f-c8d2-43d2-b3b2-342ad0f6629c' class='xr-var-attrs-in' type='checkbox' disabled><label for='attrs-f9fbf26f-c8d2-43d2-b3b2-342ad0f6629c' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-7db4ed62-0c72-4925-adbe-1b0e4bc95a40' class='xr-var-data-in' type='checkbox'><label for='data-7db4ed62-0c72-4925-adbe-1b0e4bc95a40' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'></dl></div><div class='xr-var-data'><pre>array(&#91;'2020-01-01T00:00:00.000000000', '2020-01-02T00:00:00.000000000',
      ...
      dtype='datetime64&#91;ns&#93;')</pre></div></li><li class='xr-var-item'><div class='xr-var-name'><span class='xr-has-index'>site</span></div><div class='xr-var-dims'>(site)</div><div class='xr-var-dtype'><U1</div><div class='xr-var-preview xr-preview'>'a' 'b' 'c'</div><input id='attrs-90fd7638-c633-41bc-9537-f1cc4bd2afcd' class='xr-var-attrs-in' type='checkbox' disabled><label for='attrs-90fd7638-c633-41bc-9537-f1cc4bd2afcd' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-b7377870-2238-4afa-bd2f-7faee8c35b26' class='xr-var-data-in' type='checkbox'><label for='data-b7377870-2238-4afa-bd2f-7faee8c35b26' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'></dl></div><div class='xr-var-data'><pre>array(&#91;'a', 'b', 'c'&#93;, dtype='<U1')</pre></div></li></ul></div></li><li class='xr-section-item'><input id='section-3cf63d41-7cb9-4cc9-837d-ff576aea89d8' class='xr-section-summary-in' type='checkbox' checked /><label for='section-3cf63d41-7cb9-4cc9-837d-ff576aea89d8' class='xr-section-summary' title='Expand/collapse section'>Data variables: <span>(2)</span></label><div class='xr-section-inline-details'></div><div class='xr-section-details'><ul class='xr-var-list'><li class='xr-var-item'><div class='xr-var-name'><span>temperature_anomaly</span></div><div class='xr-var-dims'>(time, site)</div><div class='xr-var-dtype'>float64</div><div class='xr-var-preview xr-preview'>...</div><input id='attrs-1b996e1f-7b91-4da2-b8a4-e5f962c6dc8f' class='xr-var-attrs-in' type='checkbox' ><label for='attrs-1b996e1f-7b91-4da2-b8a4-e5f962c6dc8f' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-5e860910-3496-43a8-a8ab-bf232d3a6fee' class='xr-var-data-in' type='checkbox'><label for='data-5e860910-3496-43a8-a8ab-bf232d3a6fee' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'><dt><span>units :</span></dt><dd>degC</dd><dt><span>long_name :</span></dt><dd>near-surface air temperature</dd></dl></div><div class='xr-var-data'><pre>&#91;270 values with dtype=float64&#93;</pre></div></li><li class='xr-var-item'><div class='xr-var-name'><span>anomaly_range</span></div><div class='xr-var-dims'>(site)</div><div class='xr-var-dtype'>float64</div><div class='xr-var-preview xr-preview'>...</div><input id='attrs-ed14952b-a38e-4748-9f0a-6ff3de57f434' class='xr-var-attrs-in' type='checkbox' ><label for='attrs-ed14952b-a38e-4748-9f0a-6ff3de57f434' title='Show/Hide attributes'><svg class='icon xr-icon-file-text2'><use xlink:href='#icon-file-text2'></use></svg></label><input id='data-a92d99a3-39ec-4e79-a4cc-f086be80b849' class='xr-var-data-in' type='checkbox'><label for='data-a92d99a3-39ec-4e79-a4cc-f086be80b849' title='Show/Hide data repr'><svg class='icon xr-icon-database'><use xlink:href='#icon-database'></use></svg></label><div class='xr-var-attrs'><dl class='xr-attrs'><dt><span>units :</span></dt><dd>degC</dd><dt><span>long_name :</span></dt><dd>near-surface air temperature</dd></dl></div><div class='xr-var-data'><pre>&#91;3 values with dtype=float64&#93;</pre></div></li></ul></div></li><li class='xr-section-item'><input id='section-8dba70fb-a827-4833-8b8d-8d8f44fa7289' class='xr-section-summary-in' type='checkbox' checked /><label for='section-8dba70fb-a827-4833-8b8d-8d8f44fa7289' class='xr-section-summary' title='Expand/collapse section'>Attributes: <span>(4)</span></label><div class='xr-section-inline-details'></div><div class='xr-section-details'><dl class='xr-attrs'><dt><span>units :</span></dt><dd>degC</dd><dt><span>long_name :</span></dt><dd>near-surface air temperature</dd><dt><span>conduit_config :</span></dt><dd># The smallest pipeline that still has every moving part: an input file, an
